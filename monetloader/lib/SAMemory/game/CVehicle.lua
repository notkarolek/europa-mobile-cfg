...
shared.ffi.cdef[[
	...
	struct CVehicle : CPhysical
	{
		...
		char 								field_4EC; // NumOilSpillsToDo
		float 							oilSpillLastX;
  	float               oilSpillLastY;
		...
		char 								field_510; // m_nRadioStation
		char 								field_511; // m_nRainHitCount
		char 								field_512; // m_nSoundIndex
		char 								nVehicleWeaponInUse;
		unsigned int     		nHornCounter;
		char 								field_518; // m_nHornPattern
		char 								field_519; // m_NoHornCount
		char 								field_51A; // ComedyControlsState
		char       					nHasslePosId;
