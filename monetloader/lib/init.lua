...
function module.getLocalPlayerId()
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	return tostring(this.sLocalPlayerID)
end

function module.getLocalPlayerPing()
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	return tostring(this.iLocalPlayerPing)
end

function module.getLocalPlayerScore()
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	return tostring(this.iLocalPlayerScore)
end

function module.getMaxPlayerId()
	local this = module.Get().pBase.pPools.pPlayer
	if ( this == 0x0 ) then return end
	return tostring(this.ulMaxPlayerID)
end
...
function module.getServerPort()
	local this = module.Get().pBase
	if ( this == 0x0 ) then return end
	return tostring(this.ulPort)
end

function module.getGameState()
	local this = module.Get().pBase
	if ( this == 0x0 ) then return end
	return tostring(this.iGameState)
end
-- 0.3 functions!
function module.isChatOpen()
	local this = module.Get().pChatInput.pDXUTEditBox
	if ( this == 0x0 ) then return end
	if tostring(this.bIsChatboxOpen) == "0" then
		return false
	elseif tostring(this.bIsChatboxOpen) == "1" then
		return true
	end
end
...
function module.getServerWeather()
	local this = module.Get().pBase.pSettings
	if ( this == 0x0 ) then return end
	return tostring(this.byteWeather)
end

function module.isDialogOnScreen(pDialogId)
	local this = module.Get().pRecentDialog
	if ( this == 0x0 ) then return end
	if pDialogId == nil then return end
...
function module.isAnyDialogOnScreen()
	local this = module.Get().pRecentDialog
	if ( this == 0x0 ) then return end
	if tostring(this.iIsActive) == "0" then
		return false
	elseif tostring(this.iIsActive) == "1" then
		return true
	end
end
...
function module.getDialogId()
	local this = module.Get().pRecentDialog
	if ( this == 0x0 ) then return end
	return tostring(this.uiDialogID)
end

function module.getDialogStyle()
	local this = module.Get().pRecentDialog
	if ( this == 0x0 ) then return end
	return tostring(this.iType)
end
...
function module.isPlayerConnected(playerId)
	...
	if tostring(this.iIsListed[playerId]) == "0" then return false end
	if tostring(this.iIsListed[playerId]) == "1" then return true end
end
